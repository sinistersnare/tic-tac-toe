...
arrToBoard :: [Tile] -> Board
arrToBoard (one:two:three:four:five:six:sev:eig:nine:[]) =
  [((1,1), one),((1,2), two),((1,3), three),
  ((2,2), four),((2,2), five),((2,3), six),
  ((2,3), sev),((3,2), eig),((3,3), nine)]
arrToBoard xs = undefined

pnt :: Board -> IO ()
pnt b = putStrLn $ showBoard b
